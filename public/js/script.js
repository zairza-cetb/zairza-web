...
firebase.auth().onAuthStateChanged((user) => {
  ...
  const eventBtn = `<a href="/skills/user-dashboard"><li class="skillsBtn lg:w-28 text-center transition block text-white hover:text-blue-500 hover:shadow-md px-4 py-1 lg:py-2 lg:my-0 my-1 lg:ml-2 font-normal bg-zairza-orange hover:bg-white duration-300 ease-in-out rounded-full lg:animate-bounce">Skills++</li></a>`;
